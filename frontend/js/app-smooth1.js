...
import { enableTableFilters, enableTableSorting } from "./utils.js?v=tables-unified1";
import * as dashboard from "../pages/dashboard.js?v=login-repair1";
import * as products from "../pages/products.js?v=products-modern2";
import * as suppliers from "../pages/suppliers.js?v=parties-modern1";
...
import * as salesOrders from "../pages/salesOrdersClean.js?v=order-filters1";
