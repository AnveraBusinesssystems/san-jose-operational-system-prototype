...
assert.match(html, /p2-system\.js\?v=10/);
assert.match(html, /p2\.js\?v=4/);
assert.match(html, /p2-live-inventory\.js\?v=10/);
assert.match(html, /p2-owner-analytics\.css\?v=3/);
...
assert.match(system, /SAN JOSE FARMS · WHOLESALE PRICING/);
assert.match(system, /logo_San_Jose\.png/);
assert.match(ownerAnalyticsCss, /\.price-builder-brand img/);
assert.match(ownerAnalyticsCss, /border-bottom:4px solid #1f6b4b/);
